...
#pragma warning disable CA1707, CS3008 // Identifiers should not contain underscores
namespace ____DiagHubTrace
#pragma warning restore CA1707, CS3008
{
    using System;
    using System.Diagnostics;
    using System.Runtime.InteropServices;

    internal sealed class DiagHubTrace : IDisposable
    {
        public const ushort FirstValidId = 1;
        public const ushort MaxValidId = 0x7fff;
        ...
        public void InsertMark(ushort id)
        {
            if (this.started)
            {
                ...
                this.FireUserEventWithString(id, string.Empty);
            }
        }
        ...
        private void Shutdown()
        {
            ...
            {
                this.started = false;
                _ = NativeMethods.EventUnregister(this.regHandle);
            }
        }
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
            ...
            _ = NativeMethods.EventWrite(this.regHandle, ref evtDesc, userData.Length, userDataPinned.AddrOfPinnedObject());
        ...
        private void FireUserEventWithString(ushort id, string? message)
        {
            ...
            GCHandle userDataPinned = GCHandle.Alloc(userData, GCHandleType.Pinned);
            _ = NativeMethods.EventWrite(this.regHandle, ref evtDesc, 1, userDataPinned.AddrOfPinnedObject());
