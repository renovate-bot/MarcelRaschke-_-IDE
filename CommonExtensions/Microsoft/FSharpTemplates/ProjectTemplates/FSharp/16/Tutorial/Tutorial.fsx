...
///    Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// Aprire gli spazi dei nomi con la parola chiave 'open'.
//
// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// risultati utili.
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Per altre informazioni su questi operatori, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Per altre informazioni sull'applicazione parziale, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Per altre informazioni su questo operatore, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Per altre informazioni sulle classi, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Per altre informazioni sui membri, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
module DefiningClasses =
    ...
    /// Consente di ottenere un nuovo oggetto vettore dimensionato senza modificare l'oggetto originale.
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Per altre informazioni, vedere: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
