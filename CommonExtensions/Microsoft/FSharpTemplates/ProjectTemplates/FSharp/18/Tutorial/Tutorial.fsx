...
///    자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// 'open' 키워드를 사용하여 네임스페이스를 엽니다.
//
// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// 구성됩니다.
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
/// 부분 애플리케이션을 사용합니다.
///
/// 이러한 연산자에 대해 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// 부분 애플리케이션에 대해 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // 이 연산자에 대해 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
/// 나타냅니다.
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// 클래스에 대해 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// 멤버에 대해 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// 자세히 알아보려면 다음 페이지 참조: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
