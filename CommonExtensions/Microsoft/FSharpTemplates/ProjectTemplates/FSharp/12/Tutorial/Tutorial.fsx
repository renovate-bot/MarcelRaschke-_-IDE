...
///    Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// Ouvrir des espaces de noms à l'aide du mot clé 'open'.
//
// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// résultats utiles.
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Pour en savoir plus sur ces opérateurs, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Pour en savoir plus sur l'application partielle, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Pour en savoir plus sur cet opérateur, voir : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Pour en savoir plus sur les Cours, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Pour en savoir plus sur les membres, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Pour en savoir plus, consultez : https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
