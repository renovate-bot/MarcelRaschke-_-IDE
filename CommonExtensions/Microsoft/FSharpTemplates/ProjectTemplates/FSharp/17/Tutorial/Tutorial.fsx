...
//   [対話形式で実行] を選択します。[表示] メニューから F# インタラクティブ ウィンドウを開くことができます。
// *******************************************************************************************************
//
...
///    詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// 'open' キーワードを使用して名前空間を開きます。
//
// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// 有用な結果。
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
/// 部分適用を利用します。
///
/// これらの演算子の詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// 部分適用の詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // この演算子の詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    /// [電話番号] および [検証済み] フィールド。
    ///
    /// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
/// ケースを表します。
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// クラスの詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
module DefiningClasses =
    ...
    /// 元のオブジェクトを変更せずに、新しくスケーリングされたベクター オブジェクトを取得します。
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// 詳細については、次を参照してください: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
