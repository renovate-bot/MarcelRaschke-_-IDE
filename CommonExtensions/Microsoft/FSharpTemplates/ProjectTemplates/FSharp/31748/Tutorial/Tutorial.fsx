...
//     [工具] --> [延伸模組和更新] --> [連線] 並搜尋
//
// 如需有關搭配 F# 一起使用的其他範本，請參閱 Visual Studio 中的 [線上範本]，
//     [新增專案] --> [線上範本]
...
///    若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// 使用 'open' 關鍵字開啟命名空間。
//
// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
/// 否則無法對其進行變更。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// 實用的結果。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
/// 元組是簡單的資料值合併為合併值。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
/// 其會利用局部應用程式。
///
/// 若要深入了解這些運算子，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// 若要深入了解局部應用程式，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
/// 在 F# 核心程式庫的 'List' 模組中。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // 若要深入了解此運算子，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
/// 序列處理函式也可以套用到清單和陣列。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
/// 遞迴是處理 F# 中序列或集合的慣用方法。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
/// 它們不可變動，且具有結構相等的語意。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    /// [Phone] 與 [Verified] 欄位。
    ///
    /// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
/// 使用 null 參考的狀況。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
/// 接著可以在這些值上執行型別安全算術。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// 若要深入了解類別，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// 若要深入了解成員，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
/// 在下列範例中，'T 是類別的型別參數。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
/// 物件類型與物件運算式可以實作介面。
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// 若要深入了解，請參閱: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
