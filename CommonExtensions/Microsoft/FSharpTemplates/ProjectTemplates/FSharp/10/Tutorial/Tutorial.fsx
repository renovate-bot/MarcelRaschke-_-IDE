...
///    Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// Abra los espacios de nombres con la palabra clave "open".
//
// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// resultados útiles.
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Para obtener más información sobre estos operadores, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Para obtener más información sobre la aplicación parcial, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Para obtener más información sobre este operador, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Para obtener más información sobre las clases, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Para obtener más información sobre los miembros, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Para obtener más información, consulte: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
