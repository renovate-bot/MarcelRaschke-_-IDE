...
///    有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// 使用 "open" 关键字打开命名空间。
//
// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
/// 这些值无法更改，除非被显式标记为可变。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// 有用的结果。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
/// 元组是组合成组合值的简单数据值组合。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
/// 它使用偏函数应用。
///
/// 若要深入了解这些运算符，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// 若要深入了解偏函数应用，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
/// 在 F# 核心库的 "List" 模块中。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // 若要深入了解此运算符，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
/// 序列处理函数也可以应用于列表和数组。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
/// 递归是 F# 中处理序列或集合的首选方式。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
module RecordTypes =
    ...
    /// “电话”和“已验证”字段。
    ///
    /// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
/// DU 中存储的数据可以为多个不同值之一。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
/// 语言使用 null 引用的用例。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
/// 然后，你便可以对这些值执行类型安全算术。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// 若要了解关于类的详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
///
/// 若要深入了解成员，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
/// 以下示例中，"T" 表示类的类型参数。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
/// 对象类型和对象表达式可以实现接口。
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// 有关详细信息，请参阅: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
