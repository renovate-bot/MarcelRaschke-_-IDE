...
///    Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// Otevírejte obory názvů pomocí klíčového slova open.
//
// Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-3immutable
module Immutability =
...
/// užitečné výsledky.
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Další informace o těchto operátorech najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Další informace o částečném použití argumentů: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Další informace o tomto operátoru najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Další informace o třídách najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Další informace o členech najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Další informace najdete v tématu: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Další informace najdete tady: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
