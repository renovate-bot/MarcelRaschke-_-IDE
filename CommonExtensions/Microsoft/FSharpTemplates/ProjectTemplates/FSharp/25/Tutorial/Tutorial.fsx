...
///    Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// Открывайте пространства имен с помощью ключевого слова "open".
//
// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
/// полезные результаты.
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Подробности об этих операторах: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Подробности о частичном применении: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Подробности об этом операторе: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Подробности о классах: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Подробности об элементах: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Подробности: https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
