...
///    Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/xml-documentation


// 'Open' anahtar sözcüğünü kullanarak ad alanlarını açın.
//
// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/import-declarations-the-open-keyword
open System
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/modules
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#why-immutable
module Immutability =
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/strings
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/tuples
module Tuples =
...
///
/// Bu işleçler hakkında daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#function-composition-and-pipelining
/// Kısmi Uygulama hakkında daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/#partial-application-of-arguments
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/lists
module Lists =
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/arrays
module Arrays =
    ...
    //
    // Bu işleç hakkında daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/values/index#mutable-variables
    array2.[1] <- "WORLD!"
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/sequences
module Sequences =
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/functions/index#recursive-functions
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/records
module RecordTypes =
    ...
    ///
    /// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/copy-and-update-record-expressions
    let contact2 =
        { contact1 with
            Phone = "(206) 555-0112"
            Verified = true }
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/discriminated-unions
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/pattern-matching
module PatternMatching =
    ...
    //
    // Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/active-patterns
    let (|Int|_|) = parseInt
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/options
module OptionValues =
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/units-of-measure
...
///
/// Sınıflar hakkında daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/classes
///
/// Sınıflar hakkında daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/generics/
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/interfaces
...
///
/// Daha fazla bilgi için bkz. https://learn.microsoft.com/dotnet/articles/fsharp/language-reference/members/events
module Events =
