      ...
      events: [
        {
          ...
          description: "Fired when the attached Blazor DotnetDebugger itself, not the blazor app being debugged, encounters an error.",
          parameters: [
            {
              name: "exceptionType",
...
var getDefinition = async (url) => {
  const { body } = await (0, import_got.default)(url, { responseType: "json" });
  return body;
};
async function generate() {
  ...
  const domains = jsProtocol.domains.concat(browserProtocol.domains).concat(nodeCustom_default.domains).concat(jsDebugCustom_default.domains).concat(wasmCustom_default.domains).sort(compareDomains);
  const result = [];
...
@${key}`;
  ...
  function generateTelemetryClassifications(domains2) {
    const propertiesClassifications = domains2.map((domain) => {
...
// SIG // iBx53h0L9vy7bxvQwl+woeqfVAdYzOTu8WRNjqTc8Pyg
...
// SIG // DQEJBDEiBCCycNg2h9yIc/2bYpEez9ViNRbIvHNCaw5X
// SIG // geGv7BsRPTBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBp
// SIG // AGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNy
// SIG // b3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAGT7z8LU
// SIG // I7AC3Ni9Wdn1KT8jPnbEMS7+OuOfm8iVVjwfWgeWJCxJ
// SIG // 0sGoQKPkvQOnhfZJ6ytbvbUioVgJW8jnfJ+Uc1mIqjZX
// SIG // sKMz0KQUQUNH13sFVaw8L4U+HJSp0g1GJxkBdq0kAk3g
// SIG // U3E5WNTK32EfT0BtDcs550dgJy4urk5W+7cOFmupoP1X
// SIG // fqLmoCvvkb1LjrFq5JBo+CtDJ38ZRqTJX5GHu3AxOX4d
// SIG // trk4aR0lLHRXLY+ovKZ+tFfz30rrvHN7zklsbAJbXpzO
// SIG // //YvBpZaEtyG77hJkaqvRO+6g8jvzhpvNa9xWncWKPPE
// SIG // 2RpQy16j5r9Y0Jqnj9emFhd8G6WhghesMIIXqAYKKwYB
...
// SIG // MTANBglghkgBZQMEAgEFAAQghyfefg1Jd24TvA9/QLXd
// SIG // /xuI1qmJIuqBxO6ixx1aO+kCBmdisd7EwxgTMjAyNDEy
// SIG // MzEwOTA4NTYuNjU5WjAEgAIB9KCB2aSB1jCB0zELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // CRABBDAvBgkqhkiG9w0BCQQxIgQgoU2DFfZ/jy+Nea6J
// SIG // bpVZ/n7fE5w2apRaoQAE5V8P684wgfoGCyqGSIb3DQEJ
...
// SIG // 6l8vFi5WCN/IMA0GCSqGSIb3DQEBCwUABIICAKGBI2vQ
// SIG // cSzt2w1bd5dyTxYy9/k/X4tEpEXCNPl5uQWlEvcjdn9O
// SIG // q9POJNjoL2iNz5zUEwlNkhWoHxgB5vZm2wcWYhQHK+xS
// SIG // RDyq0IiYXpNF9WuALq4cxXfvSooP3Y0WUjLeBkz27NSv
// SIG // jXGw+kXAuJLwPeKjk5m/AsxK981zVaO4mSrFQ7zPRd+6
// SIG // Iy1xYU16nypufn6KafRE8Q1hEhweD+jd143CMUw8BYrd
// SIG // tdW/VY4+ghYuKqom8b+zBPNoLgBiRpN7jVxGMnjU35Pi
// SIG // GSywCLQ08dLicZjDRpcUz+ibOqs70XmwGvGibwoiSSHY
// SIG // seJH+BxHFd5A24UFedTxZr9RYb6rCtYWi63LUNxrofeO
// SIG // LDKU2qAg+DNEXfDC8E7APND+t8zISQuAee0nW5rY6YB8
// SIG // +DfU2Jzcuddgtc39FUXg0qdq6XUt7eH7o4c9iCXESo30
// SIG // X0Y45nHZl/CXPmFpx+CYFvD4oWxC58wudZnOg4Xx+ud+
// SIG // HvZ5FYSxKh2weNzhON4jFngR0MF25wC73IIt3P81Pa8t
// SIG // zpuPbByMGW307837kd5G0IAU7alAHUInwhF3d3AyW/Eb
// SIG // V1o8UyKhhlEoZIFLAipdXFqgOxWzUDVvbzOXGZWMx8Ec
// SIG // lQxLrEqyTIvZl0hema9yTiOu99Zejm1j23wq6tRfzhut
// SIG // 9WoNgSgrOKsD6tjO
