...
-- for Windows cluster, LOCATION should be '/tmp/SensorSampleData/'
SET sample_data_path = /tmp/SensorSampleData;
-- for Linux cluster, LOCATION should be '/tmp/HdiSamples/SensorSampleData/'
-- SET sample_data_path = /tmp/HdiSamples/SensorSampleData;
...
CREATE EXTERNAL TABLE hvac(loggingdate STRING, s_time STRING, targettemp BIGINT,
