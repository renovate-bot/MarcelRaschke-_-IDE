...
async function findTests() {
    ...
    try {
        ...
        throw new Error("TESTADAPTER_ERROR:Failed to load TestFramework (" + process.argv[2] + "), " + exception);
    }

    try {
        const testFilesListInputFile = process.argv[3];
        if (!fs.existsSync(testFilesListInputFile)) {
            throw new Error("testFilesListInputFile '" + testFilesListInputFile + "' does not exist.");
        }

        let testFilesList = fs.readFileSync(testFilesListInputFile, "utf-8");
        ...
        throw new Error("TESTADAPTER_ERROR:TestFramework (" + process.argv[2] + ") threw an exception processing (" + process.argv[3] + "), " + exception);
    }
}
module.exports.FindTests = findTests;

// Some frameworks output ANSI/Unicode characters that the Test Explorer output doesn't handle well. This function filters them out.
function filterOutput() {
    ...
    process.stdout.write = (chunk, encoding, callback) => {
        if (typeof chunk === 'string') {
            chunk = removeUnwantedChars(chunk);
        } else if (Buffer.isBuffer(chunk)) {
            chunk = Buffer.from(removeUnwantedChars(chunk.toString()));
        }
...
function removeUnwantedChars(str) {
    ...
    return str.replace(ansiRegex, '').replace(unicodeRegex, '');
}

// Checking if it's a call from the command line (Visual Studio), otherwise it's a script call from our debugging session.
...
// SIG // 0OLwXgMbEq/2RrXKheEt5e4LM/kXWiGjUbLQ52gbj5Wg
...
// SIG // DQEJBDEiBCDZUtVUSzAsJJYQt4n0BOdDdTtY1+KMg9zN
// SIG // AAtHAwvHcjBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBp
// SIG // AGMAcgBvAHMAbwBmAHShGoAYaHR0cDovL3d3dy5taWNy
// SIG // b3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAGuqxKZP
// SIG // RMmnGgi6+B+ituu63EDBFuoUlalcjRlOSlzfmcE0akvC
// SIG // lX9dLaN/xSNLKqJDCSJOm9719smdXD+r/3fIdkXEcqwG
// SIG // ba446QdjOkzj0YqtuE9cIbqF8zAa1lHaZb6v4OtqElxY
// SIG // ns6Gjlal4Vgk3qTNDNg0SLPVtyVeJyXOSDKfQjg6MZHI
// SIG // jq6Qf+av4qTl2T3+qSj6Z4T+CiTHjQIo5HefmJkoGTR7
// SIG // /SLrNjUXS2uBltpxF52UhFyFMD4jOVR8J3uf4aPVsgAn
// SIG // qA2EK8Nhzp+YjzaZUzpOUYWXhXFg/WVNb1T4/TGh1xSV
// SIG // Q5gYlAckVC2vbRtxkXb3vVBun4uhgheUMIIXkAYKKwYB
// SIG // BAGCNwMDATGCF4Awghd8BgkqhkiG9w0BBwKgghdtMIIX
// SIG // aQIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUgYLKoZIhvcN
// SIG // AQkQAQSgggFBBIIBPTCCATkCAQEGCisGAQQBhFkKAwEw
// SIG // MTANBglghkgBZQMEAgEFAAQg8cbDhmCGQ1Ebgw4rSUdu
// SIG // Es7QmF5OkFQmxNYicZxVnd8CBmda//UbpxgTMjAyNDEy
// SIG // MjQwOTE0MzIuNzA5WjAEgAIB9KCB0aSBzjCByzELMAkG
// SIG // A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAO
// SIG // BgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
...
// SIG // BgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgXAfo
// SIG // 8+YMIsLZWZp33jyobMqsivMpGDouxtMsQCTJhgswgfoG
...
// SIG // BIICAAl1k8UlHxkwwSarjjg/zL3Es7NQGPT/c++b7JZN
// SIG // N0LmwiC96SycjMbfTbOjndDyPgHzqXnilT061NtkE15Z
// SIG // JH/OFsUzw7LT1wChVbBXWmLyJj2WoJWklLwJj5Z+E+F/
// SIG // IN4+hKzwpQwyDzjKd+499PPm8EkXHku+cB7VZBO1DOHF
// SIG // 4vwFLEwHupO2FIDluw1RoRnV5LGNh22FOrethOwKp69k
// SIG // sWhP/r+gcjZQ4o60OKjcgpSBhhhy6r6lWwDvmd3/f/6l
// SIG // KPaRX1Lbk+kJb8HrP694/7DMbcG5v0gPSOiNdcizUKUz
// SIG // Jix34ecAw8xOEgb3be/x5BXSuEzxj40sbKn39cZ+844M
// SIG // 5dcCUnfn1r7Aa7UW/oGWtCj9vPNNnMtqd96BI191u2xz
// SIG // bejfYN8gb6l2lQoALfxgpDlu5cVoL4RmgjMQaOwKpatL
// SIG // mSKyMhVvUmAMJ+DadMw5wem5HSoIOmGx9r40El29I+HT
// SIG // 2NP4dEdlbvlD2nZRTmHK7J8sznAzF+MRb88BX4+6x9qJ
// SIG // jIKKKaogUZaLn6uqtZU0CcBt6kqkrl5q3Yudk0SwDh8Y
// SIG // yP0WencngDKcU26pNd5wCtMFc56kAMasknMwAIMrX09P
// SIG // Ek0p5qddwW47Lc34jFdhj/cycKShgQjrxNev3TOU0c2q
// SIG // Yhu2hLCXCwTcGZfpeo0pc800BpAi
